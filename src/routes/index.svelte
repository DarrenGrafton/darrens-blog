...
>
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div class="flex flex-col pr-8">
			...
			<h2 class="mb-4 text-gray-700 dark:text-gray-200">
				<br />
				I plan to write about <span class="font-semibold">.Net, Azure, Svelte</span><br /><br
				/>Refreshed for 2022!
			</h2>
	...
	<section class="mb-16 w-full">
		<h3 class="mt-4 mb-6 text-2xl font-bold tracking-tight text-black dark:text-white md:text-4xl">
			Featured Posts
		</h3>
		<div class="flex flex-col gap-6 md:flex-row">
			<FeatureCard
				title="Svelte in Razor Views!"
				href="/svelte-razor-views"
				stringData="Apr 2022"
			/>
		</div>
		<a
